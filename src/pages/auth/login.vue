  ...
  <div class="flex min-h-screen bg-white/70 dark:bg-dark-1/50">
    ...
    <div class="flex flex-row w-full">
      ...
      <div class="hidden lg:flex flex-col justify-between bg-[#00aaff] lg:p-8 xl:p-12 lg:max-w-sm xl:max-w-1/2 text-white">
        ...
        <div class="space-y-5">
          <h1 class="lg:text-3xl xl:text-5xl xl:leading-snug font-general font-extrabold">
      ...
      <div class="flex flex-1 flex-col items-center justify-center px-10 relative">
        ...
        <div class="flex flex-1 flex-col justify-center space-y-5 max-w-md">
          ...
          <div class="flex flex-col max-w-md space-y-5">
            ...
            <a-button type="outline" size="large" shape="round" class="!h-auto !rounded-full text-lg/12" @click="() => $message.error('This is an error message!')">
              <template #icon>
